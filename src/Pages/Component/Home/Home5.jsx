...
// --- Use your provided images ---
import innolact from '../../../assets/Images/Innolact.png';
import R3 from '../../../assets/Images/R3.png';
import makki from '../../../assets/Images/makki.jpg';
...
यह प्रभावी, कोमल और टिकाऊ है।
            ...
            <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3">
                    ...
                    <span className={colors.textSecondary}>मक्खियों, टिकों और सामान्य कीटों को दूर भगाता है।</span>
                </div>
                 <div className="flex items-center gap-3">
                    <CheckCircle size={20} className="text-green-500 flex-shrink-0"/>
                    <span className={colors.textSecondary}>जानवरों की त्वचा और कोट के लिए गैर-चिढ़ाने वाला और सुरक्षित।</span>
                </div>
                 <div className="flex items-center gap-3">
                    <CheckCircle size={20} className="text-green-500 flex-shrink-0"/>
                    <span className={colors.textSecondary}>Eco-friendly and biodegradable ingredients</span>
                </div>
            </div>
             <Pill as="a" href="#makkhi-details" variant="read-more">
                Learn more about the science
             </Pill>
          </div>
          {/* Image Column */}
          <div className="md:col-span-6 lg:col-span-6 order-1 md:order-2">
             <div className="relative rounded-2xl h-96 overflow-hidden aspect-square md:aspect-[5/6] shadow-2xl group"> {/* Adjusted aspect ratio */}
                 <img
                    src={makki}
                    alt="Makkhi Fly Repellent being used or product shot"
