...
import WellnessCheckImage from "../../../assets/Images/twelve.png";
        ...
        <main className="p-4 md:p-8 flex flex-col space-y-8">
          ...
          <section className="flex flex-col-reverse md:flex-row items-center gap-6">
            ...
            <div className="w-full md:w-1/2 flex justify-center px-4 md:px-0">
              <Link
                to="/services/wellness-exams"
                aria-label="Proactive Wellness Exams"
              >
                <img
                  src={WellnessCheckImage}
                  alt="Veterinarian performing a wellness check on a dog"
                  className="w-full max-w-xs sm:max-w-sm md:max-w-full h-auto md:h-[400px] object-cover rounded-xl transition-transform duration-300 hover:scale-105"
                />
              </Link>
            </div>
          </section>
              ...
              <Card className="relative bg-green-500 text-white rounded-3xl p-6 overflow-hidden flex-1 group">
                ...
                <div className="relative z-10">
                  <h3 className="text-xl sm:text-2xl font-semibold mb-1">
                    WeightBooster: Nutritional Mix
                  </h3>
                  <p className="text-sm opacity-90">
                    Support healthy weight gain &amp; muscle development
                  </p>
                </div>
                <Button
                  variant="secondary"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="flex flex-col items-start">
                  ...
                  <p className="text-sm text-gray-600">
                    of dedicated pet care experience
                  </p>
                </div>
