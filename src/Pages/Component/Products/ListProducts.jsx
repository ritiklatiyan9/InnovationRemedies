...
const products = [
  { id: 'r3-vet-ultra-bonus',       name: 'R3-Vet : Ultra Bonus (1 pcs)',      description: 'limited fruity collection', price: 142.00, imageUrl: R3,      gradientFrom: '#FFE0E6' },
  { id: 'mood-pills',               name: 'AYNGROW (1 pcs)',                 description: 'limited fruity collection', price: 142.00, imageUrl: nine,    gradientFrom: '#F8E0FF' },
  { id: 'uti-dont-think-so',        name: 'Badda-H (1 pcs)',                 description: 'limited fruity collection', price: 142.00, imageUrl: eight,   gradientFrom: '#E6E6FA' },
  { id: 'bye-bye-bloat',            name: 'CalfShakti Advanced (1 pcs)',     description: 'limited fruity collection', price: 412.00, imageUrl: thirteen,gradientFrom: '#E0F2FF' },
  { id: 'good-girl-probiotic',      name: 'IRL Innoliv-DS (1 pcs)',         description: 'limited fruity collection', price: 412.00, imageUrl: fourteen,gradientFrom: '#D9F7F0' },
  { id: 'perfect-condition-vitamin',name: 'IRL Innoworm-XL (1 pcs)',        description: 'limited fruity collection', price: 412.00, imageUrl: fifteen, gradientFrom: '#E0F8E0' },
  ...
  { id: 'makkhi-soap',              name: 'IRL Makkhi Soap',                description: 'Regular checkups for year-round health.', price: 719.95, imageUrl: seventeen,gradientFrom: '#E0EFFF' },
  { id: 'makkhi-liquid',            name: 'Makkhi Concentrated Liquid',     description: 'Concentrated liquid formula.', price: 719.95, imageUrl: eighteen,gradientFrom: '#E0EFFF' },
  { id: 'makkhi-injection',         name: 'Makkhi Injection',               description: 'Injectable health boost.', price: 179.95, imageUrl: nineteen,gradientFrom: '#E0EFFF' },
];
