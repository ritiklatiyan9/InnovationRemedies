...
import { Home, ShoppingBag, Book, Users, Mail, Menu, ChevronRight } from 'lucide-react';
              ...
              <SheetContent side="right" className="w-64 sm:w-72 bg-gradient-to-b from-white to-sky-50 shadow-xl flex flex-col">
                ...
                <div className="p-4 border-t border-gray-100 bg-white/50">
                  <Link to="/login" onClick={() => setIsOpen(false)}>
                    <button className="w-full text-left flex items-center gap-3 p-3 rounded-lg hover:bg-red-50 text-green-600 text-sm transition">
                      Login
                    </button>
                  </Link>
                </div>
